...
//    url = [NSMutableString stringWithFormat:@"https://maps.googleapis.com/maps/api/geocode/json?address=%@",
//           [input stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
    
//    NSString *urll = [NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/autocomplete/json?input=%@&sensor=%@&key=%@",
//                            [input stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding],
//                            SPBooleanStringForBool(sensor), key];
